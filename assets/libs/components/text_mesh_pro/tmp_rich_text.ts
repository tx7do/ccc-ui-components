...
import {HtmlTextParser, IHtmlTextParserResultObj, IHtmlTextParserStack} from "./utils/html_parser";
import TextMeshPro from "./text_mesh_pro";
import TmpUtils from "./utils/tmp_utils";
...
export default class TmpRichText extends Component {
    ...
    protected _calculateSize(styleIndex: number, s: string) {
        ...
        return label.node._uiProps.uiTransformComp!.contentSize;
    }
