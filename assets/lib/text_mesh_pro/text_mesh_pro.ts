...
import TmpFontConfig from "./utils/tmp_font_config";
import TmpAssembler, {TmpLetterInfo} from "./utils/tmp_assembler";
...
export default class TextMeshPro extends UIRenderer {
    ...
    protected _canRender() {
        ...
        return !(!this.fontConfig || this.textures.length <= 0);
    }
