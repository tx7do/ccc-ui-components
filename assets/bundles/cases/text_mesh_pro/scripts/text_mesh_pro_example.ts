...
import TmpUtils from "db://assets/libs/components/text_mesh_pro/utils/tmp_utils";
import TextMeshPro from "db://assets/libs/components/text_mesh_pro/text_mesh_pro";

const {ccclass, property} = _decorator;

@ccclass('text_mesh_pro_example')
export default class TextMeshProExample extends Component {
